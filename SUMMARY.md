...
* [Access Compute Engine via VS Code](README.md)
* [Bitwarden CLI Backup](scripts/bitwarden-cli-backup.md)
* [Docker](scripts/docker.md)
* [Subnets](scripts/subnets.md)

## AWS CODE

* [AWS CodeDeploy](aws-code/aws-codedeploy/README.md)
  * [Environment Variables](aws-code/aws-codedeploy/environment-variables.md)
  * [CodePipeline Connection](aws-code/aws-codedeploy/codepipeline-connection.md)
  * [Questions](aws-code/aws-codedeploy/questions.md)
* [CodeCommit](aws-code/codecommit/README.md)
  * [whys](aws-code/codecommit/whys.md)
  * [Questions](aws-code/codecommit/questions.md)

## management

* [AWS Config](management/aws-config/README.md)
  * [SS: Settings](management/aws-config/ss-settings.md)
* [Organizations](management/organizations/README.md)
  * [Invitation Flow](management/organizations/invitation-flow.md)
* [Cloudwatch](management/cloudwatch.md)
* [Cloudtrail](management/cloudtrail/README.md)
  * [Questions](management/cloudtrail/questions.md)
* [Event Bridge](management/event-bridge/README.md)
  * [whys](management/event-bridge/whys.md)
  * [Questions](management/event-bridge/questions.md)
...
* [WAF](aws-security/waf.md)
* [Firewall](aws-security/firewall/README.md)
  * [Security Account Delegation](aws-security/firewall/security-account-delegation.md)
  * [Security Policies](aws-security/firewall/security-policies/README.md)
    * [Lists](aws-security/firewall/security-policies/lists.md)
...
* [Lambda](compute/lambda/README.md)
  ...
  * [Provisioned vs Reserved](compute/lambda/provisioned-vs-reserved.md)
  * [Questions](compute/lambda/questions.md)

## STORAGE

* [Comparisons](storage/comparisons.md)
* [Aurora](storage/aurora/README.md)
  * [Aurora Cluster](storage/aurora/aurora-cluster.md)
  * [Questions](storage/aurora/questions.md)
  * [Data Flowchart](storage/aurora/data-flowchart.md)
...
* [Transit Gateway](network/transit-gateway.md)
* [Network - NAT Gateway](network/network-nat-gateway.md)

## MANAGEMENT - SERVICES

* [CloudFormation](management-services/cloudformation/README.md)
  * [Components](management-services/cloudformation/components.md)
  * [Template Parts](management-services/cloudformation/template-parts.md)
  ...
  * [Screenshots](management-services/cloudformation/screenshots/README.md)
    ...
    * [Drifts](management-services/cloudformation/screenshots/drifts.md)
  * [Questions](management-services/cloudformation/questions.md)
